...
ROOT_DATASET = '/tudelft.net/staff-bulk/ewi/insy/VisionLab/xinliu/tmp/tsm/temporal-shift-module/'  # '/data/jilin/'
...
def return_movingmnist(modality):
    filename_categories = 'movingmnist/labels/classInd.txt'
    if modality == 'RGB':
        root_data = ROOT_DATASET + 'movingmnist/jpg'
        filename_imglist_train = 'movingmnist/file_list/movingmnist_rgb_train_split_1.txt'
        filename_imglist_val = 'movingmnist/file_list/movingmnist_rgb_val_split_1.txt'
        prefix = '{}.jpg'
    elif modality == 'Flow':
        root_data = ROOT_DATASET + 'movingmnist/jpg'
        filename_imglist_train = 'movingmnist/file_list/movingmnist_flow_train_split_1.txt'
        filename_imglist_val = 'movingmnist/file_list/movingmnist_flow_val_split_1.txt'
        prefix = 'flow_{}_{:05d}.jpg'
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix

def return_breakfast(modality):
    filename_categories = 'Breakfast/labels/classInd.txt'
    if modality == 'RGB':
        root_data = ROOT_DATASET + 'Breakfast/jpg'
        filename_imglist_train = 'Breakfast/file_list/breakfast_rgb_train_split_1.txt'
        filename_imglist_val = 'Breakfast/file_list/breakfast_rgb_val_split_1.txt'
        prefix = 'img_{:06d}.jpg'
    elif modality == 'Flow':
        root_data = ROOT_DATASET + 'UCF101/jpg'
        filename_imglist_train = 'UCF101/file_list/ucf101_flow_train_split_1.txt'
...
def return_thumos(modality):
    filename_categories = 'Thumos/labels/classInd.txt'
    if modality == 'RGB':
        root_data = ROOT_DATASET + 'Thumos/jpg'
        filename_imglist_train = 'Thumos/file_list/thumos_rgb_train_split_1.txt'
        filename_imglist_val = 'Thumos/file_list/thumos_rgb_val_split_1.txt'
        prefix = 'img_{:06d}.jpg'
    elif modality == 'Flow':
        root_data = ROOT_DATASET + 'UCF101/jpg'
        filename_imglist_train = 'UCF101/file_list/ucf101_flow_train_split_1.txt'
...
def return_jester(modality):
    ...
    if modality == 'RGB':
        prefix = '{:05d}.jpg'
        root_data = ROOT_DATASET + 'Jester/jpg'
...
def return_dataset(dataset, modality):
    dict_single = {'jester': return_jester, 'something': return_something, 'somethingv2': return_somethingv2,
                   ...
                   'kinetics': return_kinetics, 'ucf11': return_ucf101, 'breakfast': return_breakfast,
                   'thumos': return_thumos, 'movingmnist': return_movingmnist}
