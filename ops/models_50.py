...
from ops.my_resnet50 import MyResNet50
...
class TSN(nn.Module):
    ...
    def _prepare_base_model(self, base_model):
        ...
        if 'resnet' in base_model:
            ...
            self.base_model = MyResNet50()
            self.base_model.load_state_dict(models.resnet50(pretrained=(self.pretrain == 'imagenet')).state_dict())
            if self.is_shift:
                # print('Fake Adding temporal shift...')
